...
const READING_ACTIVE = require('./reading_active.png');
const MUSIC = require('./music.png');
const MUSIC_ACTIVE = require('./music_active.png');
const MOVIE = require('./movie.png');
const MOVIE_ACTIVE = require('./movie_active.png');
...
const ONE_FILL = require('./one_fill.png');
const ALL = require('./all_line.png');
